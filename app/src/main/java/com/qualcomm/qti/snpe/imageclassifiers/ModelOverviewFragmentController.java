    ...
    public void classify(final Bitmap bitmap) {
        if (mNeuralNetwork != null) {
            ...
            switch (mNetworkTensorFormat) {
                case UB_TF8:
                    task = new ClassifyImageWithUserBufferTf8Task(this, mNeuralNetwork, newBitmap, mModel);
                    break;
                case FLOAT:
                default:
                    task = new ClassifyImageWithFloatTensorTask(this, mNeuralNetwork, newBitmap, mModel);
                    break;
            }
